/* mca-rtc.js — Riverbend Playhouse (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.MUSICAL_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.MusicalMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
